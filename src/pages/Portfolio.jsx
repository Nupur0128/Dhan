...
const top25Companies = [
  { sno: 1,  name: 'Reliance Industries', amount: '₹53,76,787.15' },
  { sno: 2,  name: 'HDFC Bank',           amount: '₹⁠60,00,578.25' },
  { sno: 3,  name: 'Bharti Airtel',       amount: '₹3,00,159' },
  { sno: 4,  name: 'ICICI Bank',          amount: '₹12,46,789.17' },
  { sno: 5,  name: 'SBI',                 amount: '₹45,77,890.70' },
  { sno: 6,  name: 'TCS',                 amount: '₹⁠33,50,700.50' },
